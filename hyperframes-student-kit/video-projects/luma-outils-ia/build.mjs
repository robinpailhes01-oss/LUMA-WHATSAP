...
<div id="root" data-composition-id="${ID}" data-start="0" data-width="${W}" data-height="${H}" data-duration="${DUR}">
  ...
  <audio id="music" data-start="0" data-duration="${DUR}" data-track-index="12" data-volume="0.45" src="assets/music.m4a"></audio>
${sfxAudio}
</div>`;
...
<title>LUMA — Les 3 outils IA de mon entreprise (v003)</title>
